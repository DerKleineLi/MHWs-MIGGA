...
re.on_draw_ui(function()
    ...
    if imgui.tree_node("Kinsect, Don't Come Back!") then
        ...
        if imgui.tree_node("Tripple Up Config") then
            ...
            changed, config_table["aim_attack_start"] = imgui.slider_int("Aim Attack Start", config_table["aim_attack_start"], 1, #speed_types, speed_types[config_table["aim_attack_start"]])
            changed, config_table["aim_attack_end"] = imgui.slider_int("Aim Attack End", config_table["aim_attack_end"], 1, #speed_types, speed_types[config_table["aim_attack_end"]])
